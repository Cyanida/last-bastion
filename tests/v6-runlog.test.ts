...
const LOG: RunLog = {
  at: '2026-09-22T20:00:00.000Z', classId: 'viking', tier: 0, arena: 'courtyard', seed: 7, daily: null, curses: [], trait: 'none',
  time: 220, wave: 3, level: 4, kills: 50, end: 'slain', cause: 'an Orc', relics: { whetstone: 2 }, talents: [], upgrades: [],
...
describe('run log (v0.6)', () => {
  ...
  it('keeps the build and how the run ended', () => {
    ...
    expect(log.end).toBe('quit'); // the sim stopped it, nobody killed it
  });
