...
- **Relics** (v0.7, [RELICS.md](RELICS.md)):
  - **Where they come from.** Relics come at fixed moments: every wave boss, lairs, strongboxes, quests that promise one, the Merchant and Armorer's Choice. Each moment is a pick of one from three, with a reroll and a **Skip** that pays gold and a Rune shard.
  ...
  - **Duos.** Hold one specific relic from each of two families and a wave boss offers their **duo** (12 in all) as a gold fourth card. A duo counts toward both families.
