...
export const sprite = robedSprite({
  id: 'lich', S, tall: 66,
  robe: 'violet', panel: 'darksteel', trim: 'gold', hand: 'white', fx: 'soulfire',
  head(f, head) {
    ...
    f.part(head, sc([[0.8, -6.4], [4.6, -6.4], [4.4, -3.4], [3.4, -2.8], [2.6, -3.8], [1.8, -3], [0.8, -3.6]]), 'darksteel', 5.05, { profile: 'flat', outline: false, details: dt([[1.7, -4.8, 'soulfire', 6], [3.8, -4.8, 'soulfire', 5]]) }); // eye sockets, soul-lit
  ...
  top(f, st, p) {
    ...
    f.part(st, E(0, -28, 2.6 + p.magic * 0.4, 2.6 + p.magic * 0.4), 'soulfire', 6.9); // soul orb
  },
});
