...
export const sprite = robedSprite({
  ...
  robe: 'red', panel: 'white', trim: 'gold', hand: 'skin', fx: 'fire',
  head(f, head) {
    f.part(head, sc([[-4.2, -1], [-4.6, -6], [-3.4, -9], [3.6, -9], [5, -6], [5.4, -3], [4.6, 0.6], [2.6, 2.2], [-1.6, 2]]), 'skin', 5, {
      details: dt([[1.8, -6, 'skin', 0], [2.8, -6.4, 'skin', 0], [3.8, -6.2, 'skin', 0], [2.8, -5, 'white', 6], [3.6, -5, 'darksteel', 0], [5.4, -3.4, 'skin', 1], [5.4, -2.6, 'skin', 1], [2.8, -0.6, 'skin', 0], [3.8, -0.6, 'skin', 0], [-1.6, -4, 'skin', 1], [-1.6, -3, 'skin', 1]]),
  ...
  top(f, st, p) {
    ...
    f.part(st, sc([[-2.4, -24], [2.4, -24], [1.6, -27 - p.magic * 0.8], [0.4, -25.6], [-0.6, -29 - p.magic], [-1.4, -25.8]]), 'fire', 6.87, { profile: 'flat' }); // its flame
    f.part(st, E(0, -24.8, 1, 1), 'fire', 6.88, { outline: false });
  },
});
