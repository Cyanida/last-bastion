...
export const EVENTS = {
  peddler: { name: 'Wandering merchant', icon: '🧺', desc: 'A peddler sets up his pack for the wave. Walk up to him to trade.', wares: 2, reach: 50 },
  cursedChest: { name: 'Cursed chest', icon: '📦', desc: 'A chest that hums. A relic inside, and the horde’s best around it.', elites: 3, reach: 40 },
