...
const T = {
  ...
  cursedLuck: { name: 'Cursed Luck', desc: 'Elites drop relics twice as often; you take 15% more damage.', icon: '🎲', unlock: { achievement: 'eliteHunter' }, mods: { armor: -0.15 }, n: { relicChance: 2 } },
