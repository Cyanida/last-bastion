...
export const EVOLUTIONS = {
  ...
  dayOfJudgement: evo('paladin', 'signature', 'Day of Judgement', '⚖️', [{ kind: 'upgrade', id: 'judgement' }, { kind: 'relic', id: 'echoBell', tier: 2 }],
  ...
  starfall: evo('angel', 'utility', 'Starfall', '🌠', [{ kind: 'utility', id: 'afterimage' }, { kind: 'relic', id: 'echoBell', tier: 2 }],
