...
export const CLASSES: Record<ClassId, ClassDef> = {
  ...
  necromancer: {
    ...
    role: 'Summoner',
    sprite: 'necromancer',
    base: { hp: 100, str: 3, dex: 4, int: 12, atkSpd: 0.8, moveSpd: 160, secondary: 5 }, // v0.8 #125: hp 85 -> 100, growth 5 -> 6, 3 skeletons: capping the Colossus (#126) left the maxed bot winning 1 run in 4 (BALANCE.md)
