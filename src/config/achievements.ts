...
export interface AchievementDef {
  ...
  unlocks?: { arena?: ArenaId; relic?: RelicId };
}
...
export const ACHIEVEMENTS: AchievementDef[] = [
  { id: 'firstBlood', name: 'First Blood', desc: 'Slay 100 enemies.', target: 100, progress: (s) => s.counters.kills },
  { id: 'slayer', name: 'Butcher of the Bastion', desc: 'Slay 5,000 enemies.', target: 5000, progress: (s) => s.counters.kills },
  { id: 'wave10', name: 'Holding the Line', desc: 'Reach wave 10 with any class.', target: 10, progress: bestWave, unlocks: { arena: 'graveyard' } },
  ...
  { id: 'bossSlayer', name: 'Giant Killer', desc: 'Defeat a boss.', target: 1, progress: (s) => s.counters.bosses },
  { id: 'bossHunter', name: 'Boss Hunter', desc: 'Defeat 5 bosses.', target: 5, progress: (s) => s.counters.bosses, unlocks: { arena: 'keep' } },
  ...
  { id: 'treasurer', name: 'Treasurer', desc: 'Bank 5,000 gold in total.', target: 5000, progress: (s) => s.counters.goldEarned },
