...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: 'wave20all', name: 'Five Banners', desc: 'Reach wave 20 with all five classes.', category: 'survival', tiers: tiers([5], { 1: { title: 'Banner-Bearer' } }), progress: (s) => classes(s).filter((c) => c.bestWave >= 20).length, unlocks: { relic: 'conquerorCrown' } },
