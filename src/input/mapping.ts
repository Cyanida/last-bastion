...
export type Action = 'pause' | 'mute' | 'confirm' | 'cancel' | 'reroll' | `pick${1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9}`;
...
const KEY_ACTIONS: Record<string, Action> = {
  Escape: 'pause', KeyP: 'pause', KeyM: 'mute', Enter: 'confirm', NumpadEnter: 'confirm', Backspace: 'cancel', KeyR: 'reroll',
};
